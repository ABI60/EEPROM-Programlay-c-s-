...
unsigned char readIO(){
    ...
    result += (PORTCbits.RC7 << 1);
    result += (PORTBbits.RB0 << 2);
    result += (PORTBbits.RB5 << 3);
    result += (PORTBbits.RB4 << 4);
    result += (PORTBbits.RB3 << 5);
    result += (PORTBbits.RB2 << 6);
    result += (PORTBbits.RB1 << 7);
    return result;
}
